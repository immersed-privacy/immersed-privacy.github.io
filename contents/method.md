...
Each social state is represented with multi-channel perceptual cues: egocentric images capturing visual indicators and audio clips capturing the ambient soundscape — without textual labels.
